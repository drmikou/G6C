			...
			<div id="bloc_echange">								
				<div class="bloc_echange1">
					<?php echo $donnees['echange_prod1']; 
						  ...
						  echo '<img src="../vue/images/fruits_legumes/'.$donnees["echange_prod1"].'.jpg" title="'.$donnees["echange_prod1"].'"alt="Image 														flottante2" width="150" heigh="150" />';
					?>	
				</div>

				<div class="bloc_echange2">
					<?php echo '<img src="../vue/images/fruits_legumes/'.$donnees["echange_prod2"].'.jpg" title="'.$donnees["echange_prod2"].'"alt="Image flottante2" width="150" heigh="150" />';
