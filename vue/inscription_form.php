<form method="post" action="inscription.php" enctype="multipart/form-data">
		...
		<h4>Inscription </h4>
			...
			<label for="birth">* Date de naissance:</label>  <input name="birth" required type="date" id="birth" /><br/> <br/><br/>
			...
			<label for="password">* Mot de Passe : </label><input type="password" required name="password" id="password" />
			<label for="confirm">* Confirmer le mot de passe : </label><input type="password" required name="confirm" id="confirm"/><br/> <br/><br/>
			...
			<label for="phone">Votre numéro de téléphone: </label><input type="tel" name="phone" id="phone" /><br/><br/><br/>
