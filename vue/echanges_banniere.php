                        ...
                        <?php 
                            ...
                            if(isset($reponse)){
                             ...
                             while ($donnees = $reponse->fetch()){
                                ...
                                echo' <a href="../controleur/fruit_legume.php?barre_recherche='.$donnees["echange_prod1"].'"><img src="../vue/images/fruits_legumes/'.$donnees["echange_prod1"].'.jpg" title="'.$donnees["echange_prod1"].'"alt="'.$donnees["echange_prod1"].'" class="imageflottante"width="100" heigh="100" /></a> ';
